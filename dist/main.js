...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_constructorModule_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/constructorModule.js */ \"./src/modules/constructorModule.js\");\n\r\n\r\n\r\nconst consumeAPI = __webpack_require__(/*! ./modules/consumeAPIModule.js */ \"./src/modules/consumeAPIModule.js\");\r\nconst displayResults = __webpack_require__(/*! ./modules/resultsModule.js */ \"./src/modules/resultsModule.js\");\r\n\r\nconst myURL = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games';\r\nconst uID = '/LvQpFtQWItmg0slGlX3Q/scores/';\r\n\r\nconst refreshBtn = document.getElementById('refresh');\r\nconst submitBtn = document.getElementById('submit');\r\n\r\ndisplayResults(myURL, uID);\r\n\r\nrefreshBtn.addEventListener('click', () => {\r\n  displayResults(myURL, uID);\r\n});\r\n\r\nsubmitBtn.addEventListener('click', async () => {\r\n  const competent = document.querySelector('#name').value;\r\n  const marks = document.querySelector('#score').value;\r\n  const competentScore = new _modules_constructorModule_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](competent, marks);\r\n  await consumeAPI.printScore(myURL, uID, JSON.stringify(competentScore));\r\n  displayResults(myURL, uID);\r\n  const inputs = document.querySelectorAll('#name, #score');\r\n  inputs.forEach((input) => {\r\n    input.value = '';\r\n  });\r\n});\r\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");

/***/ }),

/***/ "./src/modules/constructorModule.js":
/*!******************************************!*\
  !*** ./src/modules/constructorModule.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nclass Score {\r\n    constructor(user, score) {\r\n      this.user = user;\r\n      this.score = score;\r\n    }\r\n  }\r\n  \r\n  /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Score);\r\n  \n\n//# sourceURL=webpack://leaderboard/./src/modules/constructorModule.js?");

/***/ }),

/***/ "./src/modules/consumeAPIModule.js":
/*!*****************************************!*\
  !*** ./src/modules/consumeAPIModule.js ***!
  \*****************************************/
/***/ ((module) => {

eval("const fetchScores = async (actual, id) => {\r\n    const response = await fetch(`${actual}${id}`)\r\n      .then((response) => response.json());\r\n    return response.result;\r\n  };\r\n  \r\n  const printScore = async (actual, id, data) => {\r\n    const response = await fetch(`${actual}${id}`, {\r\n      method: 'POST',\r\n      body: data,\r\n      headers: {\r\n        'Content-type': 'application/json; charset=UTF-8',\r\n      },\r\n    })\r\n      .then((response) => response.json());\r\n    return response;\r\n  };\r\n  \r\n  module.exports = { fetchScores, printScore };\n\n//# sourceURL=webpack://leaderboard/./src/modules/consumeAPIModule.js?");

/***/ }),

/***/ "./src/modules/resultsModule.js":
/*!**************************************!*\
  !*** ./src/modules/resultsModule.js ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("const consumeAPI = __webpack_require__(/*! ./consumeAPIModule.js */ \"./src/modules/consumeAPIModule.js\");\r\n\r\nconst showResult = async (actualURL, myID) => {\r\n  const scores = await consumeAPI.fetchScores(actualURL, myID);\r\n  const tbody = document.querySelector('tbody');\r\n  let tbodyData = '';\r\n  scores.forEach((element) => {\r\n    tbodyData += ` <tr>\r\n        <td>${element.user}</td>\r\n        <td>${element.score}</td>\r\n    </tr>`;\r\n  });\r\n  tbody.innerHTML = tbodyData;\r\n};\r\n\r\nmodule.exports = showResult;\n\n//# sourceURL=webpack://leaderboard/./src/modules/resultsModule.js?");
